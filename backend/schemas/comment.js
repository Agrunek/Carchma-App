...
const statusPattern = z.enum([COMMENT_POSITIVE, COMMENT_INFORMATIVE, COMMENT_NEGATIVE], { error: 'Invalid status' });
const contentPattern = z.string().min(1).max(1000);
const reactionPattern = z.enum([REACTION_LIKE, REACTION_DISLIKE], { error: 'Invalid reaction value' });
