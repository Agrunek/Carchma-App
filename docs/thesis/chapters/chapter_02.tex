W ramach projektu została zrealizowana aplikacja internetowa, będąca serwisem z ogłoszeniami o sprzedaży samochodów.
...
\section{Zrealizowane wymagania funkcjonalne}

\subsection{Autentykacja i autoryzacja użytkowników}
...
\subsection{Zamieszczanie ogłoszeń o sprzedaży samochodów}
...
\subsection{Dodawanie i ocenianie opinii pod ofertami}
...
\subsection{Wyszukiwarka ofert w oparciu o reputację sprzedawcy}
...
\subsection{System zgłoszeń dla ofert i komentarzy}
...
\subsection{Przechowywanie nieaktualnych ogłoszeń w archiwum}
...
\section{Zrealizowane wymagania niefunkcjonalne}
